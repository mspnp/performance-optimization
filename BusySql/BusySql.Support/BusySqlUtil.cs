...
namespace BusySql.Support
{

   

    public class BusySqlUtil
    {
        private static Dictionary<string, string> Query = new Dictionary<string, string>();

        private const string ResourceFileBase = "BusySql.Support.";
        ...
        private static string GetSqlQuery(string file)
        {
            ...
            var assembly = Assembly.GetAssembly(typeof(BusySqlUtil));
